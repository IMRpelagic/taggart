...
This project is licensed under the GNU GPLv3 License - see [LICENSE](LICENSE.md). The data is licensed under Creative Commons [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/) license and can be downloaded from [Norwegian Marine Data Centre](http://metadata.nmdc.no/metadata-api/landingpage/f9e8b1cff4261cf6575e70e56c4c3b3e). 
...
```{r, echo = TRUE, fig.width = 10, fig.height = 4, message = FALSE}
library(ggplot2)
library(lubridate)
# Download the data
d <- tg_catches()
